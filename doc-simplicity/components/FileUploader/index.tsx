...
import { FileValidator, defaultPdfConfig, FileValidationResult } from "./FileValidator";
...
export default function FileUploader({
  ...
  const fileValidator = new FileValidator(validationConfig);
  ...
  const handleFileSelect = useCallback(async (file: File) => {
    // Validate file
    const validationResult: FileValidationResult = fileValidator.validate(file);
